...
def _config(vector_db_path: str, max_questions: int = 8) -> Config:
    return Config(
        ...
        ollama_host="http://localhost:11434", viva_duration_minutes=30, max_questions=max_questions, max_questions_explicit=True,
        ...
        line_window_size=60, line_window_overlap=15, vector_db_path=vector_db_path, top_k_retrieval=5, max_retrieval_distance=None,
